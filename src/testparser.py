...
grammar = Grammar(rules=[Rule(name='expr', productions=[Production(items=[ProductionPart(optional=False, star=False, items=[Leaf(type='NONTERMINAL', value='factor'), Leaf(type='LITERAL', value='+++'), Leaf(type='NONTERMINAL', value='expr')])]), Production(items=[ProductionPart(optional=False, star=False, items=[Leaf(type='NONTERMINAL', value='factor'), Leaf(type='LITERAL', value='---'), Leaf(type='NONTERMINAL', value='expr')])]), Production(items=[ProductionPart(optional=False, star=False, items=[Leaf(type='NONTERMINAL', value='factor')])])]), Rule(name='factor', productions=[Production(items=[ProductionPart(optional=False, star=False, items=[Leaf(type='TERMINAL', value='INT')]), ProductionPart(optional=False, star=True, items=[Leaf(type='LITERAL', value='***'), Leaf(type='TERMINAL', value='INT')])])])])
